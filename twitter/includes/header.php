...
<div class="container row">
    ...
    <section class="wrapper">
        <div class="main-header">
            ...
            <? if (logged_in()): ?>
            <a href="<?= get_url('user_posts.php?user=' . $_SESSION['user']['id'])?>" class="header__link header__link_profile" title="Твиты пользователя"></a>
            <a href="<?= get_url('liked.php?user=' . $_SESSION['user']['id'])?>" class="header__link header__link_likes" title="Понравившиеся твиты"></a>
            <? endif; ?>
